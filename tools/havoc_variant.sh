...
echo -e "";
echo -e ${grn}" 〉 3- Test "${txtrst}${red}"        ︱ Only for the test releases by the HAVOC-OS Team"${txtrst}
echo -e "";
echo -e ${grn}" 〉 4- Final "${txtrst}${red}"       ︱ Only for the final releases by the HAVOC-OS Team"${xtrst}
echo -e "";
